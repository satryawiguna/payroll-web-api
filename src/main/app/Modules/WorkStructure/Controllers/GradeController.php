...
use App\Modules\WorkStructure\Services\GradeService;
use Illuminate\Http\JsonResponse;

class GradeController extends AbstractController
{
    private GradeService $svc;

    function __construct(GradeService $svc)
    {
        $this->svc = $svc;
    }
    ...
    /**
     * @OA\Get(
     *     path="/grades/list-cbx",
     *     summary="Get all employee grades for combobox",
     *
